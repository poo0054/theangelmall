  ...
  <div class="mod-role">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:role:delete')" :disabled="dataListSelections.length <= 0" type="danger"
    ...
    <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="selectionChangeHandle"
      ...
      <el-table-column align="center" header-align="center" label="ID" prop="roleId" width="80">
      </el-table-column>
