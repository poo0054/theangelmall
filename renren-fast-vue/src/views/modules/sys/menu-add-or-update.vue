    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="上级菜单" prop="parentName">
        <el-popover ref="menuListPopover" placement="bottom-start" trigger="click">
          <el-tree ref="menuListTree" :data="menuList" :default-expand-all="true" :highlight-current="true"
                   :props="menuListTreeProps" node-key="menuId"
      ...
      <el-form-item v-if="dataForm.type !== 2" label="菜单图标" prop="icon">
        <el-row>
          <el-col :span="22">
            ...
            <el-input v-model="dataForm.icon" v-popover:iconListPopover :readonly="true" class="icon-list__input"
