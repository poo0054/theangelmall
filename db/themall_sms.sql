/*
 ...
 Source Schema         : themall_sms

 Target Server Type    : MySQL
 Target Server Version : 50734
 File Encoding         : 65001

 Date: 27/12/2021 13:37:26
*/
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品会员价格' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_member_price` VALUES (37, 10, 2, '铜牌会员', 6300.0000, 1);
INSERT INTO `sms_member_price` VALUES (38, 10, 3, '银牌会员', 6200.0000, 1);
INSERT INTO `sms_member_price` VALUES (39, 10, 4, '金牌会员', 6100.0000, 1);
INSERT INTO `sms_member_price` VALUES (40, 10, 5, '钻石会员', 6000.0000, 1);
INSERT INTO `sms_member_price` VALUES (41, 11, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (42, 11, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (43, 11, 4, '金牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (44, 11, 5, '钻石会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (45, 12, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (46, 12, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (47, 12, 4, '金牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (48, 12, 5, '钻石会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (49, 13, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (50, 13, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (51, 13, 4, '金牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (52, 13, 5, '钻石会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (53, 14, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (54, 14, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (55, 14, 4, '金牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (56, 14, 5, '钻石会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (57, 15, 2, '铜牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (58, 15, 3, '银牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (59, 15, 4, '金牌会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (60, 15, 5, '钻石会员', 0.0000, 1);
INSERT INTO `sms_member_price` VALUES (61, 16, 2, '铜牌会员', 6300.0000, 1);
INSERT INTO `sms_member_price` VALUES (62, 16, 3, '银牌会员', 6200.0000, 1);
INSERT INTO `sms_member_price` VALUES (63, 16, 4, '金牌会员', 6100.0000, 1);
INSERT INTO `sms_member_price` VALUES (64, 16, 5, '钻石会员', 6000.0000, 1);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀活动场次' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_seckill_sku_relation` VALUES (2, NULL, 3, 1, 6666, 200, 1, 0);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品满减信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_sku_full_reduction` VALUES (10, 10, 10000.0000, 50.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (11, 11, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (12, 12, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (13, 13, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (14, 14, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (15, 15, 0.0000, 0.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (16, 16, 10000.0000, 50.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品阶梯价格' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_sku_ladder` VALUES (19, 10, 3, 1.00, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (20, 11, 0, 0.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (21, 12, 0, 0.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (22, 13, 0, 0.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (23, 14, 0, 0.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (24, 15, 0, 0.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (25, 16, 3, 1.00, NULL, 1);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品spu积分设置' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_spu_bounds` VALUES (4, 13, 500.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 14, 500.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 15, 500.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (7, 16, 500.0000, 1000.0000, NULL);
