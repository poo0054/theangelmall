...
import com.themall.model.constants.ProductConstant;
import com.themall.product.dao.AttrAttrgroupRelationDao;
import com.themall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public List<Long> listSearchAttrIds(List<Long> attrIds) {
        if (org.apache.commons.lang3.ObjectUtils.isNotEmpty(attrIds)) {
