		...
		<el-upload ref="uploader" v-model:file-list="defaultFileList"
			...
			<template #file="{ file }">
				<div class="sc-upload-list-item">
					<el-image :initial-index="preview.findIndex(n=>n==file.url)" :preview-src-list="preview" :src="file.url"
							  :z-index="9999" append-to-body
							  class="el-upload-list__item-thumbnail" fit="cover" hide-on-click-modal>
