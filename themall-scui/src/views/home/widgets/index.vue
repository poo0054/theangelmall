		...
		<div class="widgets-content">
			<div class="widgets-top">
				...
				<div class="widgets-top-actions">
					<el-button v-if="customizing" icon="el-icon-check" round type="primary" @click="save">完成
					</el-button>
								...
								<template #item="{ element }">
									<div class="widgets-item">
										...
										<div v-if="customizing" class="customize-overlay">
											<el-button class="close" icon="el-icon-close" plain size="small"
													   type="danger" @click="remove(element)"></el-button>
											<label>
												<el-icon>
