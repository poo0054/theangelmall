		...
		<el-aside width="40%">
			<el-container>
				...
				<el-main class="nopadding">
					<scTable ref="table" :apiObj="list.apiObj" highlightCurrentRow row-key="id" stripe
							 @row-click="rowClick">
						...
						<el-table-column label="进度" prop="progress" sortable width="250">
							<template #default="scope">
								<el-progress :percentage="scope.row.progress"/>
							</template>
						</el-table-column>
						<el-table-column label="创建日期" prop="datetime" sortable width="150"></el-table-column>
					</scTable>
				</el-main>
			</el-container>
		</el-aside>
