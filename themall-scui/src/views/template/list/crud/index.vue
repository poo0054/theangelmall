	...
	<el-container>
		<el-header>
			<div class="left-panel">
				...
				<el-button icon="el-icon-plus" type="primary" @click="addPage">页面新增</el-button>
			...
			<scTable ref="table" :apiObj="list.apiObj" row-key="id" stripe @selection-change="selectionChange">
				...
				<el-table-column align="right" fixed="right" label="操作" width="300">
					<template #default="scope">
						...
						<el-button plain size="small" type="primary" @click="table_edit(scope.row)">编辑</el-button>
						<el-button plain size="small" type="primary" @click="table_edit_page(scope.row)">页面编辑
						</el-button>
