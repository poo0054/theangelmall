<template>
	<el-card header="修改密码" shadow="never">
		<el-alert show-icon style="margin-bottom: 15px;" title="密码更新成功后，您将被重定向到登录页面，您可以使用新密码重新登录。"
				  type="info"/>
		<el-form ref="form" :model="form" :rules="rules" label-width="120px" style="margin-top:20px;">
			<el-form-item label="当前密码" prop="userPassword">
				<el-input v-model="form.userPassword" placeholder="请输入当前密码" show-password
			...
			<el-form-item label="确认新密码" prop="confirmNewPassword">
				<el-input v-model="form.confirmNewPassword" placeholder="请再次输入新密码" show-password
						  type="password"></el-input>
			</el-form-item>
			<el-form-item>
