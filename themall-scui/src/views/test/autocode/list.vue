<template>
			...
			<el-card shadow="never">
				<el-tabs tab-position="top">
					...
					<el-tab-pane label="API路径配置">
						<el-alert style="margin:0 0 20px 0;"
								  title="$API 映射文件: @/api/index.js 统一接口管理器, 所以需提前配置好API对象." type="warning"></el-alert>
						<el-row>
							<el-col :lg="8" :xl="12">
	...
	<el-dialog v-model="codeVisible" append-to-body destroy-on-close title="代码预览" width="60%">
		<el-alert show-icon
				  style="margin-bottom: 20px;" title="需将VUE文件放置views文件夹,路由匹配组件的路径下,如文件名为index.vue可不需要写文件名" type="success"></el-alert>
