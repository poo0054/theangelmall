...
<template>
	<el-main>
		<el-alert style="margin:0 0 20px 0;" title="二次封装el-dialog,加入加载中/最大化." type="success"></el-alert>
		...
		<el-card header="异步" shadow="never" style="margin-top: 15px;">
			...
			<el-alert style="margin-top: 20px;"
					  title="适用于页面有很多弹窗操作,利用异步组件按需加载,加快首屏的加载速度和打包体积"></el-alert>
		</el-card>
	</el-main>
	...
	<sc-dialog v-model="dialog2" :loading="dialog2Loading" :width="400" draggable title="模拟加载">
		<el-empty :image-size="80" description="NO Data"></el-empty>
		<template #footer>
			<el-button @click="dialog2 = false">取 消</el-button>
			<el-button :loading="dialog2Loading" type="primary" @click="dialog2 = false">确 定</el-button>
		</template>
	</sc-dialog>

	<sc-dialog v-model="dialog3" :show-close="false" :show-fullscreen="false" title="禁用拖拽">
		内容
		<template #footer>
