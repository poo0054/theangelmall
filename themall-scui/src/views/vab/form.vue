<template>
	<el-main>
		<el-row :gutter="15">
			<el-col :lg="6">
				<el-card header="处理逻辑说明" shadow="never">
					<el-timeline>
					...
					<el-alert
						show-icon
						title="当前版本为预览版本,并未在正式项目中实施,请谨慎使用. 更多配置以及图形化编辑器正在路上." type="warning"></el-alert>
				</el-card>
				<el-card header="双向绑定" shadow="never">
					<el-button type="primary" @click="setName">改变输入框的值</el-button>
					<el-button type="primary" @click="setConfig">改变指定栅格配置</el-button>
				</el-card>
			</el-col>
			<el-col :lg="12">
				<el-card header="动态表单渲染器" shadow="never">
					<sc-form ref="formref" v-model="form" :config="config" :loading="loading">
			...
			<el-col :lg="6">
				<el-card header="表单输出" shadow="never">
					<pre>{{ form }}</pre>
				</el-card>
			</el-col>
		</el-row>
