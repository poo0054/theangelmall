		...
		<el-row :gutter="15">
			<el-col :lg="14">
				...
				<el-card header="参数和方法" shadow="never">
					...
					<el-button plain type="primary" @click="getBase64">Base64</el-button>
					<el-button plain type="primary" @click="getBlob">Blob</el-button>
					<el-button plain type="primary" @click="getFile">File</el-button>
				</el-card>
			...
			<el-col :lg="10">
				<el-card header="已内置剪裁的上传组件" shadow="never">
					<el-alert
						...
						title="设置cropper就可以开启上传前剪裁, 并已封装compress和aspectRatio, 打开F12查看网络请求" type="success"></el-alert>
					<sc-upload v-model="uploadImg" :aspectRatio="1/1" :compress="1" :cropper="true"
