			...
			<el-tabs tab-position="top">
				<el-tab-pane label="普通打印">
					<el-alert
						...
						title="打印当前页面已存在的元素,如包含.no-print样式就忽略,分页打印就需要{page-break-after: always}控制" type="success"></el-alert>
					<el-button type="primary" @click="print">普通打印</el-button>
					<div style="height:20px"></div>
					<div ref="printMain" class="printMain">
						<div class="item">打印内容1
							<el-icon>
								<el-icon-eleme-filled/>
							</el-icon>
							<p class="no-print">忽略打印</p></div>
						<div style="page-break-after: always;"></div>
						<div class="item">打印内容2</div>
					</div>
				</el-tab-pane>
				<el-tab-pane label="动态打印">
					<el-alert style="margin-bottom:20px;" title="打印创建的DOM结构,适用于远程获取模板后打印"
