<template>
	<el-main>
		<el-alert
			...
			title="来自AVUE的灵感, 业务会有表单里含有对象数组的可能, 进行封装后进行增删改操作, 并且支持联动form表单的禁用属性" type="success"></el-alert>
		...
		<el-card shadow="never">
			<el-form ref="ruleForm" :model="form" :rules="rules" label-width="100px">
				...
				<el-form-item label="表格" prop="list">
					<sc-form-table ref="table" v-model="form.list" :addTemplate="addTemplate" drag-sort
								   placeholder="暂无数据">
						...
						<el-table-column label="数量" min-width="180" prop="val">
							<template #default="scope">
								<el-input v-model="scope.row.val" placeholder="请输入内容"></el-input>
							</template>
						</el-table-column>
						<el-table-column align="center" label="checked" prop="open" width="85">
							<template #default="scope">
								<el-checkbox v-model="scope.row.checked"></el-checkbox>
							</template>
						</el-table-column>
						<el-table-column align="center" label="开关" prop="open" width="80">
							<template #default="scope">
