	...
	<el-container>
		<el-header>
			<div class="left-panel">
				...
				<el-button :disabled="selection.length!=1" plain type="primary" @click="permission">权限设置</el-button>
			</div>
			<div class="right-panel">
				<div class="right-panel-search">
					<el-input v-model="search.keyword" clearable placeholder="角色名称"></el-input>
			...
			<scTable ref="table" :apiObj="apiObj" row-key="id" stripe @selection-change="selectionChange">
				...
				<el-table-column label="状态" prop="status" width="80">
					<template #default="scope">
						<el-switch v-model="scope.row.status" :loading="scope.row.$switch_status"
				...
				<el-table-column align="right" fixed="right" label="操作" width="170">
					<template #default="scope">
						<el-button-group>
							<el-button size="small" text type="primary" @click="table_show(scope.row, scope.$index)">
								查看
							</el-button>
							<el-button size="small" text type="primary" @click="table_edit(scope.row, scope.$index)">
								编辑
							</el-button>
