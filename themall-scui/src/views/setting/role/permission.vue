<template>
	<el-dialog v-model="visible" :width="500" destroy-on-close title="角色权限设置" @closed="$emit('closed')">
		<el-tabs tab-position="top">
			<el-tab-pane label="菜单权限">
				<div class="treeMain">
					<el-tree ref="menu" :data="menu.list" :props="menu.props" node-key="name" show-checkbox></el-tree>
				</div>
			</el-tab-pane>
			<el-tab-pane label="数据权限">
				<el-form label-position="left" label-width="100px">
					...
					<el-form-item v-show="data.dataType=='5'" label="选择部门">
						<div class="treeMain" style="width: 100%;">
							<el-tree ref="dept" :data="data.list" :props="data.props" node-key="id"
									 show-checkbox></el-tree>
						</div>
					</el-form-item>
					<el-form-item v-show="data.dataType=='6'" label="规则值">
						<el-input v-model="data.rule" :rows="6" clearable placeholder="请输入自定义规则代码"
			...
			<el-tab-pane label="控制台模块">
				<div class="treeMain">
					<el-tree ref="grid" :data="grid.list" :default-checked-keys="grid.checked" :props="grid.props"
							 node-key="key" show-checkbox></el-tree>
				</div>
			</el-tab-pane>
