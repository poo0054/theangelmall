<template>
	<el-container>
		<el-aside width="220px">
			<el-tree ref="category" :data="category" :default-expanded-keys="['系统日志']" :expand-on-click-node="false" :highlight-current="true"
					 class="menu" current-node-key="系统日志" node-key="label">
			</el-tree>
		</el-aside>
		<el-container>
				...
				<el-container>
					<el-header>
						<div class="left-panel">
							<el-date-picker v-model="date" end-placeholder="结束日期" range-separator="至"
											start-placeholder="开始日期" type="datetimerange"></el-date-picker>
						</div>
					...
					<el-header style="height:150px;">
						<scEcharts :option="logsChartOption" height="100%"></scEcharts>
					</el-header>
					<el-main class="nopadding">
						<scTable ref="table" :apiObj="apiObj" highlightCurrentRow stripe @row-click="rowClick">
