...
VALUES ('1736567360044818433', NULL, 'd980bb507726f0d2', '修改角色', 0,
        ...
        '/renren-fast/sys/role/update', '0:0:0:0:0:0:0:1%0', '127.0.1.1',
       ...
       ('1739455763511078913', NULL, 'a920245f5da82ab6', '修改角色', 0,
        'io.renren.modules.sys.controller.SysRoleController.update()', 'POST', 1, 'admin',
        '/renren-fast/sys/role/update', '10.244.0.0', '10.244.6.197',
       ...
       ('1739467443792338946', NULL, 'd76dc5560d474ae3', '保存菜单', 0,
        'io.renren.modules.sys.controller.SysMenuController.save()', 'POST', 1, 'admin', '/renren-fast/sys/menu/save',
       ...
       ('1739915528723722242', NULL, '29a40dd8b3778ea9', '修改密码', 0,
        ...
        '/renren-fast/sys/user/password', '0:0:0:0:0:0:0:1%0', '127.0.1.1',
...
VALUES (1, 0, '系统管理', NULL, 'sys', 0, 'system', 0),
       ...
       (5, 1, 'SQL监控', 'http://localhost:8088/renren-fast/druid/sql.html', 'sys:sql', 1, 'sql', 4),
